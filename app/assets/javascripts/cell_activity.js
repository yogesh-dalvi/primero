...
$(document).ready(function(){
	...
	setTimeout(function () {
		...
		if (location > 0) {
				...
				$("#cell_activity_child_registration_date_cell").closest('.row').show();
	    		$("#cell_activity_child_collateral_visits_").closest('.row').show();
				$("#cell_activity_child_programme_participationorganisationfacilitation_").closest('.row').show();
			...
			$("#cell_activity_child_registration_date_cell").closest('.row').hide();
			$("#cell_activity_child_programme_participationorganisationfacilitation_").closest('.row').hide();
